...
import staketaxcsv.kichain.constants as co
import staketaxcsv.common.ibc.handle
import staketaxcsv.common.ibc.processor
from staketaxcsv.kichain.config_kichain import localconfig
from staketaxcsv.settings_csv import KICHAIN_NODE
...
def process_tx(wallet_address, elem, exporter):
    txinfo = staketaxcsv.common.ibc.processor.txinfo(
        wallet_address, elem, co.MINTSCAN_LABEL_KICHAIN, KICHAIN_NODE)
    txinfo.url = "https://www.mintscan.io/ki-chain/txs/{}".format(txinfo.txid)
